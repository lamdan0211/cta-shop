$(document).ready(function () {
    ...
    $(document).ready(function () {
        $(".add-new-address").click(function (e) {
            $(".bg-black-opacity").removeClass("hidden"), $(".popup-add-address").removeClass("hidden");
        }),
            ...
            $(".profiles-orders #tabs-list ul li").click(function (e) {
                $(".profiles-orders #tabs-list ul li").removeClass("active"), $(this).addClass("active");
                let a = $(this).data("id");
